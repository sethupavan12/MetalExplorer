...
const psOutput = `
12720 501 sethupavan12 12.3 4.5 123456 987654 01:02:03 S+ /opt/homebrew/bin/node /Users/sethupavan12/project/node_modules/.bin/vite --host 127.0.0.1
405 1 root 0.9 0.1 17312 435507328 58-06:29:55 Ss /usr/libexec/logd
61500 61499 sethupavan12 0.1 0.2 20000 400000 02:12 S+ /Users/sethupavan12/.local/bin/mcp-server --stdio
45110 1 sethupavan12 1.5 1.2 50124 450000 2-03:04:05 S ControlCenter
`;

const lsofOutput = `
COMMAND     PID       USER   FD   TYPE             DEVICE SIZE/OFF NODE NAME
node      12720 sethupavan12   20u  IPv6 0xd5f0a80305b99b80      0t0  TCP *:3000 (LISTEN)
node      12720 sethupavan12   21u  IPv4 0xd5f0a80305b99b81      0t0  TCP 127.0.0.1:5173 (LISTEN)
mongod    47121 sethupavan12    9u  IPv4 0xdf8f692d7b1c74b0      0t0  TCP 127.0.0.1:27017 (LISTEN)
mongod    47121 sethupavan12   10u  IPv6 0x2c070dc3869233c9      0t0  TCP [::1]:27017 (LISTEN)
`;

const establishedLsofOutput = `
COMMAND     PID       USER   FD   TYPE             DEVICE SIZE/OFF NODE NAME
node      12720 sethupavan12   30u  IPv4 0xd5f0a80305b99b82      0t0  TCP 192.168.1.5:54000->8.8.8.8:443 (ESTABLISHED)
node      12720 sethupavan12   31u  IPv4 0xd5f0a80305b99b83      0t0  TCP 127.0.0.1:54001->127.0.0.1:5173 (ESTABLISHED)
ControlCe 45110 sethupavan12   12u  IPv6 0xd5f0a80305b99b84      0t0  TCP [2405:201:c019:e8d1::1]:54002->[2606:4700:4700::1111]:443 (ESTABLISHED)
`;
...
describe('parsePsOutput', () => {
  it('parses process rows and preserves commands with spaces', () => {
    ...
    expect(processes[0]).toMatchObject({
      ...
      memoryPercent: 4.5,
      name: 'node',
      command: '/opt/homebrew/bin/node /Users/sethupavan12/project/node_modules/.bin/vite --host 127.0.0.1',
      uptimeSeconds: 3723
    });
    ...
    expect(parseEstablishedLsofOutput(establishedLsofOutput)).toEqual(
      new Map([
        ...
        [
          ...
          [
            {
              localAddress: '2405:201:c019:e8d1::1',
              localPort: 54002,
