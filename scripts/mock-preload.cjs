...
const seedProcesses = [
  {
    ...
    elapsed: '02:14:08',
    state: 'S',
    command: '/opt/homebrew/bin/node /Users/demo-user/work/agent-demo/node_modules/.bin/vite --host 127.0.0.1',
    name: 'node',
    uptimeSeconds: 8048,
    ports: [
  ...
  },
  {
    ...
    elapsed: '05:41:12',
    state: 'S',
    command: '/Users/demo-user/.local/bin/mcp-server --stdio',
    name: 'mcp-server',
    uptimeSeconds: 20472,
    ports: [],
    category: 'ai-agent',
...
contextBridge.exposeInMainWorld('metalExplorer', {
  listProcesses: async () => ({
    ...
    summary: {
      ...
      userProcesses: processes.filter((process) => process.user === 'demo-user').length,
      macosSystem: 41,
      localServers: 3,
      aiAgents: 2,
      databases: 1,
