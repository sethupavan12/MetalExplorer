...
If a process command contains a secret, that secret can appear in MetalExplorer and can be sent to your configured AI endpoint if you click `AI Explain` for that process.
